...
p "Creating users..."
# USERS
user1 = User.create!(username: "florida", first_name: "Thomas", last_name: "Lacan", email: "thomas@beatween.com", password: "mdpmdp", description: "Late 90's House music producer", remote_photo_url: "https://res.cloudinary.com/djmfvqjof/image/upload/v1536137148/flo-rida.jpg")
...
song2 = Song.create!(name: "Love On The Beat", description: "For house music lovers", bpm: 142, num_of_tracks: 24, duration: 620000, user: user1, genre: genre1, remote_photo_url: "https://res.cloudinary.com/djmfvqjof/image/upload/v1536138525/love-on-the-beat.png", average_rating: 4.5)
...
song9 = Song.create!(name: "Good Feelings", description: "Summer is on ", bpm: 129, num_of_tracks: 9, duration: 233000, user: user1, genre: genre41, remote_photo_url: "https://res.cloudinary.com/djmfvqjof/image/upload/v1536139245/good_feelings.jpg", average_rating: 4)
...
track13 = Track.create!(user: user11, bpm: 129, description: "Percussions", instrument_id: instrument51, remote_uploaded_file_url: "https://res.cloudinary.com/djmfvqjof/video/upload/v1536136707/Percussion.mp3" )
