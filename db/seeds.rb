...
p "----------"
p "Creating tracks..."
track1 = Track.create!(user: user4, bpm: 100, description: "drum", track_url: "https://res.cloudinary.com/dae1kvpyn/video/upload/v1535626867/beatween/Drum_1.m4a" )
track2 = Track.create!(user: user4, bpm: 100, description: "drum", track_url: "https://res.cloudinary.com/dae1kvpyn/video/upload/v1535626862/beatween/Drum_2.m4a" )
track3 = Track.create!(user: user4, bpm: 100, description: "drum", track_url: "https://res.cloudinary.com/dae1kvpyn/video/upload/v1535626856/beatween/Drum_3.m4a" )
track4 = Track.create!(user: user4, bpm: 100, description: "synth", track_url: "https://res.cloudinary.com/dae1kvpyn/video/upload/v1535626856/beatween/Synth_1.m4a" )
track5 = Track.create!(user: user4, bpm: 100, description: "outro guitar", track_url: "https://res.cloudinary.com/dae1kvpyn/video/upload/v1535626857/beatween/Outro_Guitar.m4a" )
track6 = Track.create!(user: user4, bpm: 100, description: "synth", track_url: "https://res.cloudinary.com/dae1kvpyn/video/upload/v1535626862/beatween/Synth_3.m4a" )
track7 = Track.create!(user: user4, bpm: 100, description: "synth", track_url: "https://res.cloudinary.com/dae1kvpyn/video/upload/v1535626863/beatween/Synth_2.m4a" )
track8 = Track.create!(user: user4, bpm: 100, description: "synth", track_url: "https://res.cloudinary.com/dae1kvpyn/video/upload/v1535626864/beatween/Outro_Synth.m4a" )
track9 = Track.create!(user: user4, bpm: 100, description: "synth", track_url: "https://res.cloudinary.com/dae1kvpyn/video/upload/v1535626865/beatween/Synth_4.m4a" )
track10 = Track.create!(user: user4, bpm: 100, description: "synth", track_url: "https://res.cloudinary.com/dae1kvpyn/video/upload/v1535626868/beatween/Synth_5.m4a" )
